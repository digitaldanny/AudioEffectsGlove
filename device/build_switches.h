...
#define ENABLE_MPU6050_ESTIMATE_GYRO_ERROR  (1) // Issue #47: Script to get the average gyro error seen while the device is sitting still.
#define ENABLE_HC05_CONFIG_MSTR (0) // Issue #35: Script to configure the master HC-05's role, slave address, etc.
#define ENABLE_HAND_TRACKING_GLOVE (0) // Issue #53: Hand tracking glove's main loop (capture data, transfer to DSP Effects Rack)
